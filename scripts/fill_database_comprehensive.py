...
# All degree types
DEGREE_TYPES = [
    "Bachelor", "Master", "PhD", "MBA", "MSc", "MEng", "BEng",
    "Bachelor of Arts (BA)", "Bachelor of Science (BS)",
    "Master of Arts (MA)", "Master of Science (MS)",
    "Professional Certificate", "Diploma", "Graduate Diploma",
...
PROGRAMS_BY_FIELD = {
    ...
    "Medicine": [
        ...
        "Public Health", "Biomedical Sciences", "Clinical Psychology"
    ],
    "Law": [
        "Law", "International Law", "Commercial Law", "Constitutional Law",
        "Criminal Law", "Environmental Law", "Intellectual Property Law"
    ],
    "Arts & Humanities": [
        "English Literature", "History", "Philosophy", "Languages",
        "Cultural Studies", "Archaeology", "Music", "Fine Arts"
    ],
    "Sciences": [
        "Chemistry", "Physics", "Biology", "Mathematics",
        "Geology", "Astronomy", "Environmental Science"
    ],
    "Social Sciences": [
        "Economics", "Psychology", "Sociology", "Political Science",
        "Anthropology", "Geography", "Social Work"
    ]
}

UNIVERSITIES = {
    "Harvard University": {"country": "United States", "city": "Cambridge", "ranking": 1},
    "Stanford University": {"country": "United States", "city": "Palo Alto", "ranking": 3},
    "MIT": {"country": "United States", "city": "Cambridge", "ranking": 2},
    "University of Cambridge": {"country": "United Kingdom", "city": "Cambridge", "ranking": 4},
    "University of Oxford": {"country": "United Kingdom", "city": "Oxford", "ranking": 5},
    "University College London": {"country": "United Kingdom", "city": "London", "ranking": 8},
    "Imperial College London": {"country": "United Kingdom", "city": "London", "ranking": 11},
    ...
    "University of Melbourne": {"country": "Australia", "city": "Melbourne", "ranking": 37},
    "National University of Singapore": {"country": "Singapore", "city": "Singapore", "ranking": 15},
...
def generate_programs():
            ...
            for program_name in programs:
                ...
                for degree_type in DEGREE_TYPES:
                    ...
                    program = {
                        ...
                        "field": field,
                        "duration": "2-4 years" if degree_type in ["Bachelor", "BEng"] else "1-2 years" if "Master" in degree_type or degree_type == "MBA" else "3-5 years",
                        "tuition_fees": "$50,000 - $80,000 USD" if uni_info["country"] == "United States" else "$15,000 - $30,000 USD",
    ...
    logger.info(f"\n{'='*80}")
    logger.info(f"DATABASE FILL COMPLETE!")
    logger.info(f"{'='*80}")
    logger.info(f"Total programs created: {total_programs}")
    logger.info(f"Total universities: {len(UNIVERSITIES)}")
    logger.info(f"Average programs per university: {total_programs // len(UNIVERSITIES)}")
