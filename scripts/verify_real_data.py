...
LIVE_DATA_URL_PATTERN = r'\.ca/|\.ac\.uk/|\.edu\.au/|cmu\.edu|utoronto\.ca|ubc\.ca|mcgill\.ca|uwaterloo\.ca'
...
def verify_live_data():
    ...
    try:
        ...
        if not live_records:
            ...
            print("This might mean the live scraper hasn't run or found programs from the target domains.")
            return
