...
class TestSettings:
    ...
    def test_database_settings_defaults(self):
        ...
        assert db_settings.database_name == "university_db"
        assert db_settings.collection_name == "programs"
    ...
    def test_llm_settings_defaults(self):
        ...
        assert llm_settings.groq.model == "llama-3.3-70b-versatile"
        assert llm_settings.groq.timeout == 120
    ...
    def test_settings_from_env(self):
        ...
        class TestGroqSettings(BaseSettings):
            ...
            model_config = SettingsConfigDict(
                case_sensitive=False, env_prefix="", extra="ignore"
            )
