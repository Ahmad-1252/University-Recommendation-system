#!/usr/bin/env python
"""
Test scraping for all configured universities.
...
Usage:
    python test_all_universities.py                     # Test all universities
    python test_all_universities.py --university "Oxford"  # Test specific university
    python test_all_universities.py --max-programs 5      # Test with 5 programs per university
    python test_all_universities.py --dry-run            # Only discover links, don't scrape
"""
...
Examples:
    ...
    python test_all_universities.py --max-programs 5       # Test with 5 programs per university
    python test_all_universities.py --dry-run             # Only discover links, don't scrape
    python test_all_universities.py --output report.json   # Save report to file
        """
    )
